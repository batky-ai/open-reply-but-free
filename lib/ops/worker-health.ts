...
// On Vercel the "worker" is a 5 minute cron tick, so the heartbeat must outlive
// the gap between ticks or /api/health flaps. Set 420 there.
const WORKER_HEARTBEAT_TTL_SECONDS =
  Number(process.env.WORKER_HEARTBEAT_TTL_SECONDS) || 120;

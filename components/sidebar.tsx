  ...
  return (
    <>
      ...
      >
        ...
        >
          <Link href="/campaigns" className="text-base font-semibold">
            OpenReply
          </Link>
        </div>
        ...
        <div className="px-5 py-4 border-t border-border">
          ...
          <a href="/diagnostics" className="mt-3 block text-xs text-muted">Connection health</a>
          <a href="https://github.com/diwenne/openreply" className="mt-3 block text-xs text-muted">Powered by OpenReply</a>
        </div>
      </aside>
    </>
  );

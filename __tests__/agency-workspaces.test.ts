...
describe("agency workspace helpers", () => {
  ...
  it("does not replace a Composio connection with direct Meta", async () => {
    mockPrisma.instagramAccount.findUnique.mockResolvedValue({ workspaceId: "workspace_123", provider: "COMPOSIO" });
